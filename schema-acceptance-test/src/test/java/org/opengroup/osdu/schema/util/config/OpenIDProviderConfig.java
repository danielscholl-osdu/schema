...
package org.opengroup.osdu.schema.util.config;
...
public class OpenIDProviderConfig {
  ...
  public static OpenIDProviderConfig Instance() {
    try {
      ...
      String scopeEnv = System.getProperty("ROOT_USER_OPENID_PROVIDER_SCOPE", System.getenv("ROOT_USER_OPENID_PROVIDER_SCOPE"));
