Feature: To verify functionality of PUT schema Service
  ...
  Scenario Outline: Verify whether schema can not be registered with already existing major, but increased minor version
    ...
    Examples: 
      ...
      | "/input_payloads/postSchemaService_EmptySchema.json" | "/input_payloads/inputPayloadWithExistingVersion.json" | "400"             | "opendes" | "/output_payloads/SchemaPost_BreakingChangeError.json" |
