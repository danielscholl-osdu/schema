Feature: To verify functionality of PUT schema Service
  ...
  Scenario Outline: Verify that Schema Service's PUT API works correctly without scope field
    ...
    Examples: 
      ...
      | "authority" | "SchemaSanityTest" | "true"        | "/input_payloads/postInPrivateScope_positiveScenario.json" | "opendes" | "201"             | "/output_payloads/SchemaPost_PrivateScope_SuccessfulCreation.json" | "200"                   | "200"                   | "/output_payloads/ResolvedSchema.json" |
  ...
  Scenario Outline: Verify that Schema Service's PUT API works correctly and update schema properly
    ...
    Examples: 
      ...
      | "authority" | "SchemaSanityTest" | "true"        | "/input_payloads/postInPrivateScope_positiveScenario.json" | "opendes" | "201"             | "/output_payloads/SchemaPost_PrivateScope_SuccessfulCreation.json" | "200"                   | "200"                   | "/output_payloads/UpdatedResolvedSchema.json" | "/input_payloads/putUpdatedSchema_positiveScenario.json" |
  ...
  Scenario Outline: Verify that Schema Service's PUT API throws error if update is requested for schema which is not in development status.
    ...
    Examples: 
      ...
      | "/input_payloads/postInPrivateScope_positiveScenario.json" | "opendes" | "400"             | "/output_payloads/SchemaPut_InvalidStatusObsoletePublishedError.json" | "OBSOLETE"  |
      | "/input_payloads/postInPrivateScope_positiveScenario.json" | "opendes" | "400"             | "/output_payloads/SchemaPut_InvalidStatusObsoletePublishedError.json" | "PUBLISHED" |
  ...
  Scenario Outline: Verify that Schema Service's PUT API works like POST request when parameter from id is changed
    ...
    Examples: 
      | parameter   | value              | latestVersion | InputPayload                                               | tenant    | ReponseStatusCode | ResponseMessage                                                    | ReponseStatusCodeForPUT | ReponseStatusCodeForGET | ResponseMessageforGET                  |
      | "authority" | "SchemaSanityTest" | "true"        | "/input_payloads/postInPrivateScope_positiveScenario.json" | "opendes" | "201"             | "/output_payloads/SchemaPost_PrivateScope_SuccessfulCreation.json" | "201"                   | "200"                   | "/output_payloads/ResolvedSchema.json" |
  ...
  Scenario Outline: Verify that Schema Service's PUT API throws error if put request tries to create new record without development status
    ...
    Examples: 
      | InputPayload                                               | tenant    | ReponseStatusCode | ResponseMessage                                        | status      |
      | "/input_payloads/postInPrivateScope_positiveScenario.json" | "opendes" | "400"             | "/output_payloads/SchemaPut_InvalidStatusMessage.json" | "OBSOLETE"  |
      | "/input_payloads/postInPrivateScope_positiveScenario.json" | "opendes" | "400"             | "/output_payloads/SchemaPut_InvalidStatusMessage.json" | "PUBLISHED" |
  ...
  Scenario Outline: Verify that Schema Service's PUT API throws error if modification in schemaInfo is requested
    ...
    Examples: 
      ...
      | "/input_payloads/PUT_ModifySchemaInfo.json" | "opendes" | "201"                   | "/output_payloads/SchemaPut_SchemaInfoModification.json" | "200"                   | "/output_payloads/ResolvedSchema.json" |
  ...
  Scenario Outline: Verify that Schema Service's PUT API validates input payload
    ...
    Examples: 
      ...
      | "/input_payloads/inputPayloadWithIncorrectJSON.json" | "opendes" | "400"             | "/output_payloads/SchemaPost_IncorrectJsonError.json" |
  ...
  Scenario Outline: Verify that Schema Service's PUT API creates a empty private schema correctly.
    ...
    Examples: 
      ...
      | "authority" | "SchemaSanityTest" | "true"        | "/input_payloads/postSchemaService_EmptySchema.json" | "opendes" | "200"             | "/output_payloads/SchemaPost_PrivateScope_SuccessfulCreation.json" | "200"                   | "/output_payloads/ResolvedSchema_Empty.json" |
  ...
  Scenario Outline: Verify that Schema Service's PUT API validates input payload for JSON correctness
    ...
    Examples: 
      ...
      | "/input_payloads/inputPayloadWithIncorrectJSON.json" | "400"             | "/output_payloads/SchemaPost_IncorrectJsonError.json" | "opendes" |
  ...
  Scenario Outline: Verify that Schema Service's PUT API registers authority, source, entity and creates a private schema correctly with $ref attribute
    ...
    Examples: 
      ...
      | "authority" | "SchemaSanityTest" | "true"        | "/input_payloads/postSchemaServiceWithRef_positiveScenario.json" | "common"  | "opendes"   | "200"             | "404"                        | "/output_payloads/SchemaPost_PrivateScope_SuccessfulCreation.json" | "SHARED"      |
      | "authority" | "SchemaSanityTest" | "true"        | "/input_payloads/postSchemaServiceWithRef_positiveScenario.json" | "opendes" | "common"    | "200"             | "404"                        | "/output_payloads/SchemaPost_PrivateScope_SuccessfulCreation.json" | "INTERNAL"    |
  ...
  Scenario Outline: Verify that Schema Service supersededBy functionality work correctly
    ...
    Examples: 
      | parameter   | value              | latestVersion | InputPayload                                           | tenant    | ReponseStatusCode | ResponseMessage                                                    |
      | "authority" | "SchemaSanityTest" | "true"        | "/input_payloads/supercededInputPayload_positive.json" | "opendes" | "200"             | "/output_payloads/SchemaPost_PrivateScope_SuccessfulCreation.json" |
  ...
  Scenario Outline: Verify whether schema can not be registered with already existing major, but increased minor version
    Given I hit schema service PUT API with <InputPayload>, data-partition-id as <tenant> with increased minor version only
    Then service should respond back with error <ReponseStatusCode> and <ResponseMessage>

    Examples: 
      | InputPayload                                           | ReponseStatusCode | tenant    | ResponseMessage                                        |
      | "/input_payloads/inputPayloadWithExistingVersion.json" | "400"             | "opendes" | "/output_payloads/SchemaPost_BreakingChangeError.json" |
