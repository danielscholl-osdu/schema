...
public class MultiClusteredConfigReaderSchema implements MultiClusteredConfigReader {
    ...
    public MongoProperties readProperties(PartitionInfoAws partitionInfoAws) {
        ...
        String ssmPathPattern = "/osdu/%s/tenants/%s/schema/mongoDB";
        String secretManagerPathPattern = "/osdu/%s/tenants/%s/schema/mongoDB/credentials-arn";
        ...
        if (tableParams.size() <= 0) {
            ...
            return MongoProperties.builder()
                    ...
                    .enableTLS(enableTLS)
                    .databaseName(this.environment + "_osdu_schema")
